...
import { Wrench, Target, CheckCircle, Heart } from "lucide-react";
...
const VocationalTrainingPage = () => {
  ...
  const goals = [
    t("voc.goal1"), t("voc.goal2"), t("voc.goal3"), t("voc.goal4"), t("voc.goal5"),
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <Reveal className="order-2 lg:order-1">
              <div className="rounded-2xl overflow-hidden shadow-2xl">
                <img src={vocationalImg} alt="Youth learning carpentry skills" className="w-full h-full object-cover min-h-[400px]" />
              </div>
            </Reveal>

...
const LeadershipPage = () => {
  ...
  const goals = [
    t("lead.goal1"), t("lead.goal2"), t("lead.goal3"), t("lead.goal4"), t("lead.goal5"),
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <Reveal>
              <div className="rounded-2xl overflow-hidden shadow-2xl">
                <img src={leadershipImg} alt="Young leaders collaborating" className="w-full h-full object-cover min-h-[400px]" />
              </div>
            </Reveal>
          </div>
        </div>
